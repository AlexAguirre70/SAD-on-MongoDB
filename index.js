...
app.use('/topics', require('./controllers/topic_controllers')) // The use method tells it that when the pathname is given '/places' in the URL to acess the router js file 
